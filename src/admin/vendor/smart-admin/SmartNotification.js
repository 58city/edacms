...
var ExistMsg = 0,
    ...
    $.SmartMessageBox = function (settings, callback) {
        ...
        // SmallBox Sound
        if (isIE8orlower() == 0 && settings.sound_on) {
            var audioElement = document.createElement('audio');
            audioElement.setAttribute('src', settings.sound_path + 'messagebox.mp3');
            //$.get();
        ...
        if (settings.sound_on) {
            if (isIE8orlower() == 0) {
                ...
                if (navigator.userAgent.match('Firefox/'))
                    audioElement.setAttribute('src', settings.sound_path + settings.sound_file + ".ogg");
                else
                    audioElement.setAttribute('src', settings.sound_path + settings.sound_file + ".mp3");
    ...
    $.smallBox = function (settings, callback) {
        ...
        if (settings.icon == undefined) {
            BoxSmall = "<div id='smallbox" + SmallBoxes +
                "' class='SmallBox animated fadeInUp fast'><div class='textoFull'><span>" + settings.title +
                "</span><p>" + settings.content + "</p></div>" + IconSection + "</div>";
        } else {
            BoxSmall = "<div id='smallbox" + SmallBoxes +
                "' class='SmallBox animated fadeInUp fast'><div class='foto'><i class='" + settings.icon +
