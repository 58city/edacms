(function ($, window, document, undefined) {
     ...
     **/
    var clickEvent = (('ontouchstart' in window) || window.DocumentTouch && document instanceof DocumentTouch ? 'clickEvent' : 'click') + '.' + pluginName;
        ...
        _runLoaderWidget: function (elm) {
            ...
            _savePositionWidget: function () {
                ...
                var mainArr = self.obj.find(self.o.grid + '.sortable-grid').map(function () {
                    var subArr = $(this).children(self.o.widgets).map(function () {
                        return {
                            'id': $(this).attr('id')
                        };
                    }).get();
            ...
            _clickEvents: function () {
                ...
                headers.on(clickEvent, '.jarviswidget-fullscreen-btn', function (e) {
                    ...
                    if ($('#jarviswidget-fullscreen-mode').length) {
                         ...
                         **/
                        thisWidget.unwrap('#jarviswidget-fullscreen-mode').children('div').removeAttr('style').end().find('.jarviswidget-fullscreen-btn:first').children().removeClass(self.fullscreenClass[1]).addClass(self.fullscreenClass[0]).parents(self.pwCtrls).children('a').show();
                        /**
